...
export function LoginPage() {
  ...
  return <main className="auth-page"><section className="auth-copy"><div className="auth-brand-row"><Brand/><ThemeToggle className="auth-theme-toggle"/></div><div className="auth-message"><span className="eyebrow">Seu dinheiro, com clareza</span><h1>Planeje hoje.<br/>Avance amanhã.</h1><p>Organize as finanças da família, acompanhe metas e tome decisões melhores em um só lugar.</p></div><small>Privacidade por padrão • Seus dados protegidos</small></section>
